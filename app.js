  ...
  const users = [
        { id: 'T001', role:'teacher', email:'Jitendra Kumar', password:'teacher123', name:'Admin Jitendra Kumar' },
         { id: 'T002', role:'teacher', email:'Naman Jaiswal', password:'teacher123', name:'Admin Naman Jaiswal' },
          { id: 'T003', role:'teacher', email:'Gaurav Srivastava', password:'teacher123', name:'Admin Gaurav Srivastava' },
           { id: 'T004', role:'teacher', email:'Anjaneya Awasthi', password:'teacher123', name:'Admin Anjaneya Awasthi' },
            { id: 'T005', role:'teacher', email:'Lalima Srivastava', password:'teacher123', name:'Admin Lalima Srivastava' }
  ];
